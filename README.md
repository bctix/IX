...
But if you wish to use this bot in your own server, and have the knowledge, feel free to clone this and use it yourself.

Uses a lot of ideas from [bot-prefab](https://github.com/canta-slaus/bot-prefab/tree/main).